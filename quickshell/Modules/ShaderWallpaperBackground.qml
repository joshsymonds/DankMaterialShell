...
Variants {
    ...
    PanelWindow {
        ...
        ChromeShader {
            ...
            frontSunSpeed:           shaderWallpaperWindow.f(sceneData, "frontSunSpeed",          0.0)
            ...
            backNegSunSpeed:         shaderWallpaperWindow.f(sceneData, "backNegSunSpeed",        1.0)
            ...
            frontNegSunSpeed:        shaderWallpaperWindow.f(sceneData, "frontNegSunSpeed",       1.0)
            fastBackSunStrength:     shaderWallpaperWindow.f(sceneData, "fastBackSunStrength",    0.0)
            fastBackSunSize:         shaderWallpaperWindow.f(sceneData, "fastBackSunSize",        0.18)
            fastBackSunFrequency:    shaderWallpaperWindow.f(sceneData, "fastBackSunFrequency",   0.3)
            fastBackSunSpeed:        shaderWallpaperWindow.f(sceneData, "fastBackSunSpeed",       1.0)
            fastBackSunPaletteSpeed: shaderWallpaperWindow.f(sceneData, "fastBackSunPaletteSpeed",1.0)
